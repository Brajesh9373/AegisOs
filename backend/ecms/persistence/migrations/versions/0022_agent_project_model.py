...
def upgrade() -> None:
    add_column_if_missing("agents", "project_id TEXT")
    add_column_if_missing("agents", "model TEXT")
    add_column_if_missing("business_projects", "team_status TEXT DEFAULT 'pending'")
