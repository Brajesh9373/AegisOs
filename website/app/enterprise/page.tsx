...
export default function EnterprisePage(){
  return <>
    <section className="v3-enterprise-hero">
      <div><span>WORKSIMPLIFIED FOR ENTERPRISE</span><h1>More autonomy.<br/><em>Without giving up control.</em></h1><p>Enterprise AI needs more than intelligence. Worksimplified puts identity, permissions, policy, human judgment, observability, and audit directly into the execution layer.</p><a href="#contact">Talk to us <ArrowUpRight size={15}/></a></div>
    ...
    <section className="v3-enterprise-principle"><span>CONTROL IS PART OF EXECUTION</span><h2>Governance should not be a dashboard you look at after the AI has already acted.</h2><p>Worksimplified evaluates identity, policy, risk, system access, and human checkpoints while work is moving through the runtime.</p></section>
    ...
    <section className="v3-page-cta" id="contact"><span>ENTERPRISE WORKSIMPLIFIED</span><h2>Build an AI operating model your organization can actually govern.</h2><a href="mailto:hello@aegisos.ai">Book an enterprise demo <ArrowUpRight size={15}/></a></section>
  </>;
}
